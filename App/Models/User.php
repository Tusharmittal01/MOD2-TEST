...
class User extends \Core\Model{
    ...
    public function save(){
        ...
        $sql_users = "INSERT INTO users (username, password, fname, email, number, address) VALUES ('fname', '$password','$email', 'phone', 'address')";
...
/**
     * Summary of Update this fucntion will Update information
     * @return bool
     */
